...
train <- select(train, -c(Name, Season, Team, PlayerId, mlb_wrc_plus, WAR, mlb_pa,  wRC, wRAA, war_162))
...
Our overall accuracy will still be low as it can be awfully difficult to project out for young hitters, but our change in oversampling has bumped our accuracy from 51% to 64%.  This is still not particularly robust as we should do a better job of parameter tuning for the model but a nice jump.
